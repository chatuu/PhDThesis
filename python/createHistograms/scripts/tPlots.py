...
sigDir = f.Get("Interaction_RecoCohSig_Variable_tSquared_Cut_TwoProng")
sigDir.cd()

hist1 = sigDir.Get("hist")

backDir = f.Get("Interaction_RecoCohBkgd_Variable_tSquared_Cut_TwoProng")
backDir.cd()
...
c1.cd()
hist1.Draw("hist")
c1.SaveAs("Signalt.png")

c2.cd()
hist2.Draw("hist")
c2.SaveAs("Backgroundt.png")
...
legend.Draw()
c3.SaveAs("SignalVsBackgroundT.png")
