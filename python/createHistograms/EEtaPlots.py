...
sigDir = f.Get("Interaction_RecoCohSig_Variable_EEta_Cut_TwoProng")
sigDir.cd()

hist1 = sigDir.Get("hist")

backDir = f.Get("Interaction_RecoCohBkgd_Variable_EEta_Cut_TwoProng")
backDir.cd()


hist2 = backDir.Get("hist")

xTitle = "E_{#pi}(1-Cos(#theta_{#pi})) (GeV)"
...
c1.cd()
hist1.Draw("hist")
c1.SaveAs("SignalEEta.png")

c2.cd()
hist2.Draw("hist")
c2.SaveAs("BackgroundEEta.png")
...
legend.Draw()
c3.SaveAs("SignalVsBackgroundEEta.png")
