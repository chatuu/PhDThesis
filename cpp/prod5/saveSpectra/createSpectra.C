...
void createSpectra()
{
    ...
    //vars.push_back({"True Pion Kinetic Energy", {"Pion Energy (GeV)", Binning::Simple(1000, 0, 10), kPionEnergy}});
    ...
    lNDMC.Go();
    // const std::string fname = "def_snapshot prod_caf_R17-11-14-prod4reco.CVNprong-respin.b_nd_genie_nonswap_fhc_nova_v08_full_v1";
    ...
    //MakeTextListFile(fname, {kNuMuCCCohSig && kNumuMyQuality && kIsFiducial && kNumuTightContainND && kMuonIDCut && kTwoProng}, {"SignaleventList.txt"}, Newvars, &kStandardSpillCuts);

    TFile *f = new TFile("June_27_2020.root", "recreate");
